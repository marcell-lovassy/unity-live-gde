...
- `Packages/manifest.json` includes only dependencies required by the package: `com.unity.nuget.newtonsoft-json`.
...
- Third-party notices disclose Unity packages and Google Sheets API terms/costs.
