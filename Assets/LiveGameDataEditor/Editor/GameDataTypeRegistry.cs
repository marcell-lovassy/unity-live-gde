...
namespace LiveGameDataEditor.Editor
{
    ...
    public static class GameDataTypeRegistry
    {
        ...
        /// <see cref="IGameDataEntry"/>. Results are cached after the first call.
        /// </summary>
        public static IReadOnlyList<Type> GetEntryTypes()
        {
            ...
            foreach (var t in TypeCache.GetTypesDerivedFrom<IGameDataEntry>())
            {
        ...
        public static Type FindContainerTypeForEntry(Type entryType)
        {
            ...
            Type found = null;
            foreach (var t in TypeCache.GetTypesDerivedFrom<UnityEngine.ScriptableObject>())
            {
